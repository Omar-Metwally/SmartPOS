...
namespace SmartPOS.Infrastructure.Persistence.Data.Interceptors;

public class CentralInterceptor : SaveChangesInterceptor
{
    private readonly ConcurrentDictionary<Type, bool> _isSoftDeleteCache;
    private readonly ICurrentUserService _currentUserService;
    //private readonly JsonSerializerSettings _serializerSettings;

    public CentralInterceptor(ICurrentUserService currentUserService)
    {
        _currentUserService = currentUserService;
        _isSoftDeleteCache = new();
    }
    ...
    private void ProcessChanges(DbContext? context)
    {
        ...
        foreach (var entry in context.ChangeTracker.Entries())
        {
            if (entry.Entity is Entity entity)
            {
                ...
                ProcessAuditFields(entry, entity, userId.ToString(), currentDateTime);
