...
public class ClientSalesConfiguration : BaseTransactionConfiguration<ClientSalesTransaction>
{
    public override void Configure(EntityTypeBuilder<ClientSalesTransaction> builder)
    {
